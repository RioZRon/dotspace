...
(defvar dotspacemacs/layers/extra
  '(gnus
    ...
    themes-megapack   ;This simple contribution layer is an example. It installs around 100 themes for Emacs. You can try them easily by invoking helm-themes with: SPC T s.
    imenu-list ;imenu-listThis layer uses imenu-list to show the current buffer's index in a side bar.This is similar to `SPC j i` but displayed in a persistent sidebar instead of a completion buffer.
    )
...
(defun dotspacemacs/init/display ()
  (setq-default
   dotspacemacs-themes '(
                         ...
                         monokai
                         solarized-light)
   dotspacemacs-default-font `("fira Code"  ; Note: Bought this font
                               :size 12
                               :weight normal
                               :width normal
                               :powerline-scale 1.3)
...
(defun dotspacemacs/init/startup ()
  (setq-default
   ...
   dotspacemacs-startup-banner '"/Users/riozron/.spacemacs.d.bak/Pic/Navi.png"
